  ...
  <Link to={`/news/${article.slug}`} className="link-no-style">
    <Row className="newsPreview">
      <Col md="3">
        {article.title_image ? (
          <img
            src="../../assets/artwork/images_watermarked/black-and-white/coast.jpg" //{article.title_image}
            alt={article.title}
          />
        ) : (
      ...
      <Col md="9" sm="12">
        ...
        <div className="previewText" dangerouslySetInnerHTML={{ __html: article.html }} />
      </Col>
    </Row>
  </Link>
)
